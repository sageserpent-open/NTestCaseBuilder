...
namespace NTestCaseBuilder
    ...
    type MergedPartialTestVectorRepresentations<'Level when 'Level: comparison>(testVectorPaths: TestVectorPaths<'Level>,
        ...
        let fillOutPartialTestVectorWithIndeterminates (partialTestVectorRepresentation: MapWithSharing<_>) =
            if uint32 (partialTestVectorRepresentation: MapWithSharing<_>).Count > maximumNumberOfTestVariables
            then
...
//                                    + numberOfSuccessfulPathsFromSubtreeForFollowingIndices
        ...
        member this.MergeOrAdd (partialTestVectorRepresentationInExternalForm: MapWithSharing<_>) =
            if MapWithSharing.isEmpty partialTestVectorRepresentationInExternalForm
            then
                this
                , None
            else
