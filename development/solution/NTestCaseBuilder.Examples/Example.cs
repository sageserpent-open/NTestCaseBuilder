...
namespace NTestCaseBuilder.Examples
{
    ...
    public class ComplexExample
    {
        ...
        private delegate void PlacementOfOperationsIntoFinalOrder(
        ...
        private static void BaseCaseForPlacementOfOperationsIntoFinalOrder(Int32 numberOfIndicesToChooseFrom,
        ...
        private static PlacementOfOperationsIntoFinalOrder BuildInductiveCaseForPlacementOfOperationsIntoFinalOrder(
            IList<Operation> operationsPertainingToTheSameKeyToPlaceIntoFinalOrder, Int32 combinationSelector,
            PlacementOfOperationsIntoFinalOrder placementOfOperationsForRemainingKeysIntoFinalOrder)
        {
            return
                (numberOfIndicesToChooseFrom, mappingToAvoidPreviouslyChosenIndices, operationsPlacedIntoFinalOrder) =>
                    {
                        var numberOfIndicesToChoose1 = operationsPertainingToTheSameKeyToPlaceIntoFinalOrder.Count;
                        if (numberOfIndicesToChooseFrom < numberOfIndicesToChoose1)
                        {
                        ...
                        var indicesToPlaceAt1 = ChooseIndicesToPlaceAt(numberOfIndicesToChooseFrom,
                                                                       numberOfIndicesToChoose1, combinationSelector);

                        PlaceOperations(operationsPertainingToTheSameKeyToPlaceIntoFinalOrder, indicesToPlaceAt1,
                                        mappingToAvoidPreviouslyChosenIndices, operationsPlacedIntoFinalOrder);

                        var composedMappingToAvoidAllIndices1 = ComposeMappingToAvoidAllIndices(indicesToPlaceAt1,
                                                                                                mappingToAvoidPreviouslyChosenIndices);

                        if (numberOfIndicesToChooseFrom > numberOfIndicesToChoose1)
                        {
                            placementOfOperationsForRemainingKeysIntoFinalOrder(
                                numberOfIndicesToChooseFrom - numberOfIndicesToChoose1,
                                composedMappingToAvoidAllIndices1, operationsPlacedIntoFinalOrder);
                        }
                    };
        }
        ...
        private static void PlaceOperations(IList<Operation> operationsPertainingToTheSameKeyToPlaceIntoFinalOrder,
                                            IEnumerable<Int32> indicesToPlaceAt,
                                            MappingToAvoidPreviouslyChosenIndices mappingToAvoidPreviouslyChosenIndices,
                                            IList<Operation> operationsPlacedIntoFinalOrder)
        {
        ...
        private static IEnumerable<Int32> ChooseIndicesToPlaceAt(Int32 numberOfIndicesToChooseFrom,
                                                                 ...
                                                                 Int32 combinationSelector)
        {
            ...
            return CombinatoricUtilities.GenerateCombinationOfGivenSizePreservingOrder(numberOfIndicesToChoose,
                                                                                       indicesToChooseFrom,
                                                                                       combinationSelector);
        }
                                                                                      ...
                                                                                      C5.IList<Key> keys)
        {
            ...
            var factoryDealingWithRemainingKeys = MakeFactory(randomBehaviour, sequenceLength,
                                                              keys.View(1, keys.Count - 1));

            return MakeRecursionInductiveCaseFactory(synthesizingFactoryForOperationSequenceEnumerable,
